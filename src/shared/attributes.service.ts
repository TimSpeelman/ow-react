import { Attestation, IPv8API } from '@tsow/ow-attest/dist/types/ipv8/IPv8API';
import { AppState, LocalAttribute } from './AppStateService';
...
export class AttributesService {
    ...
    public loadIPv8Attestations() {
        return this.ipv8API.listAttestations()
            .then(attestations => {
